...
class GteQwenInstruct(AbstractEmbeddingModel):
    """
    The GteQwenInstruct class handles interactions with the gte-Qwen1.5-7B-instruct embedding model using the provided configuration.
    ...
    def __init__(
        ...
        :type cache: bool
        :param max_length: The maximum length of the input text. Defaults to 8192.
        :type max_length: int
    ...
    def load_model(self, device: str = None) -> None:
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(self.tokenizer_name, trust_remote_code=True, token=self.access_token)
        self.model = AutoModel.from_pretrained(self.model_name, device_map=device, trust_remote_code=True, token=self.access_token)
